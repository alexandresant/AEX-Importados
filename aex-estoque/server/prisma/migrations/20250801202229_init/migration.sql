...
-- CreateEnum
CREATE TYPE "MotivoEntrada" AS ENUM ('COMPRA', 'DEVOLUCAO', 'AJUSTE_ESTOQUE', 'OUTROS');

-- CreateEnum
CREATE TYPE "MotivoSaida" AS ENUM ('VENDA', 'CONSUMO', 'TROCA', 'PERDA_AVARIA', 'AJUSTE_ESTOQUE', 'OUTROS');
